const produtos = [
    {
    id: 1,
    nome: "Ração Premier Nutrição Golden",
    preco: "R$ 129,90",
    descricao: "Ração super premium para cães adultos. Rica em proteínas e ômega 3 para pelo brilhante e energia duradoura.",
    badge: "Mais vendido",
    link: "https://SEU-LINK-DE-AFILIADO-AQUI",
    img:  "https://via.placeholder.com/400x300/FFD9B3/FF8C42?text=Racao+Premier+%F0%9F%90%95"
    }
];
